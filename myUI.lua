...
-- ============ 图标 ============
local Images = {
    "ESP.png", "World.png", "Wrench.png", "Settings.png", "Node.png",
    "cursor.png", "Bullet.png", "Snapline.png", "Pistol.png", "folder.png",
    "UZI.png", "FieldOfView2.png", "Lock.png", "Aimlock.png", "Cash.png",
    "Wheatt.png", "Pickkaxe.png", "unlocked.png",
}

for _, value in Images do
    local location = library.directory .. "/assets/" .. value
    if not isfile(location) then
        local data = game:HttpGet("https://raw.githubusercontent.com/KingVonOBlockJoyce/imagessynex/main/" .. value)
...
GetImage = LPH_NO_VIRTUALIZE(function(name)
    ...
    return "rbxassetid://6034767608"  -- fallback
end)
...
--LPH_JIT_MAX(function()
    ...
    local fonts = {}; do
        local function Register_Font(Name, Weight, Style, Asset)
            ...
            local Data = {
                name = Name,
                faces = {{
                    name = "Normal", weight = Weight, style = Style,
    ...
    function library:update_theme(theme, color)
        for _, property in themes.utility[theme] do
            for m, object in property do
                if object[m] == themes.preset[theme] then object[m] = color end
            end
        end
    ...
    function library:window(properties)
        local cfg = {
            ...
            game_name = properties.gameInfo or properties.game_info or properties.GameInfo or "My Script",
        ...
        local items = cfg.items; do
            ...
            library:create("UIPadding", {
                PaddingTop = dim(0, 16), PaddingBottom = dim(0, 36),
                Parent = items["button_holder"], PaddingRight = dim(0, 11), PaddingLeft = dim(0, 10),
            })
            ...
            items["title"] = library:create("TextLabel", {
                ...
                TextColor3 = themes.preset.accent, BorderSizePixel = 0,
                RichText = true, TextSize = 30, BackgroundColor3 = rgb(255, 255, 255),
            })
            library:apply_theme(items["title"], "accent", "TextColor3")

            items["multi_holder"] = library:create("Frame", {
                Parent = items["main"], Name = "\0", BackgroundTransparency = 1,
                Position = dim2(0, 196, 0, 0), BorderColor3 = rgb(0, 0, 0),
                Size = dim2(1, -196, 0, 56), BorderSizePixel = 0,
                BackgroundColor3 = rgb(255, 255, 255),
            })
            ...
            library:create("Frame", {
                ...
                Size = dim2(1, 0, 0, 1), BorderSizePixel = 0,
                BackgroundColor3 = rgb(21, 21, 23),
            })

            items["shadow"] = library:create("ImageLabel", {
                ImageColor3 = rgb(0, 0, 0), ScaleType = Enum.ScaleType.Slice,
                Parent = items["main"], BorderColor3 = rgb(0, 0, 0), Name = "\0",
                BackgroundColor3 = rgb(255, 255, 255), Size = dim2(1, 75, 1, 75),
                AnchorPoint = vec2(0.5, 0.5), Image = "rbxassetid://112971167999062",
                BackgroundTransparency = 1, Position = dim2(0.5, 0, 0.5, 0),
                SliceScale = 0.75, ZIndex = -100, BorderSizePixel = 0,
                SliceCenter = rect(vec2(112, 112), vec2(147, 147)),
            })
            items["global_fade"] = library:create("Frame", {
                Parent = items["main"], Name = "\0", BackgroundTransparency = 1,
                Position = dim2(0, 196, 0, 56), BorderColor3 = rgb(0, 0, 0),
                Size = dim2(1, -196, 1, -81), BorderSizePixel = 0,
                BackgroundColor3 = rgb(14, 14, 16), ZIndex = 2,
            })
            ...
            library:create("Frame", {
                ...
                Size = dim2(1, 0, 0, 6), BorderSizePixel = 0,
                BackgroundColor3 = rgb(23, 23, 25),
            })

            items["game"] = library:create("TextLabel", {
                FontFace = fonts.font, Parent = items["info"],
                TextColor3 = rgb(72, 72, 73), BorderColor3 = rgb(0, 0, 0),
                Text = cfg.game_name, Name = "\0", Size = dim2(1, 0, 0, 0),
                AnchorPoint = vec2(0, 0.5), Position = dim2(0, 10, 0.5, -1),
            ...
            items["other_info"] = library:create("TextLabel", {
                ...
                Size = dim2(1, 0, 0, 0), Position = dim2(0, -10, 0.5, -1),
                AnchorPoint = vec2(0, 0.5), BorderSizePixel = 0,
                BackgroundTransparency = 1, TextXAlignment = Enum.TextXAlignment.Right,
                AutomaticSize = Enum.AutomaticSize.XY, FontFace = fonts.font,
                TextSize = 14, BackgroundColor3 = rgb(255, 255, 255),
            })
    ...
    function library:tab(properties)
        ...
        local items = cfg.items; do
            items["tab_holder"] = library:create("Frame", {
                ...
                BackgroundTransparency = 1, Position = dim2(0, 196, 0, 56),
                BorderColor3 = rgb(0, 0, 0), Size = dim2(1, -216, 1, -101),
            ...
            items["button"] = library:create("TextButton", {
                ...
                BackgroundTransparency = 1, Name = "\0", Size = dim2(1, 0, 0, 35),
                BorderSizePixel = 0, TextSize = 16, BackgroundColor3 = rgb(29, 29, 29),
            })
            items["icon"] = library:create("ImageLabel", {
                ...
                Size = dim2(0, 22, 0, 22), BorderSizePixel = 0,
                BackgroundColor3 = rgb(255, 255, 255),
            })
            ...
            library:create("UIPadding", {
                ...
                PaddingRight = dim(0, 7), PaddingLeft = dim(0, 7),
            })
            ...
            for _, section in cfg.tabs do
                ...
                local multi_items = data.items; do
                    multi_items["button"] = library:create("TextButton", {
                        ...
                        Size = dim2(0, 0, 0, 39), BackgroundTransparency = 1,
                        ClipsDescendants = true, BorderSizePixel = 0,
                        AutomaticSize = Enum.AutomaticSize.X, TextSize = 16,
                    ...
                    multi_items["accent"] = library:create("Frame", {
                        ...
                        Parent = multi_items["button"], BackgroundTransparency = 1,
                    ...
                    library:create("UIListLayout", {
                        ...
                        Parent = multi_items["tab"], Padding = dim(0, 7),
        ...
        function cfg.open_tab()
            ...
            self.selected_tab = {
                items["button"], items["icon"], items["name"],
                items["tab_holder"], items["multi_section_button_holder"],
            }
            library:close_element()
        end
    ...
    function library:column(properties)
        ...
        local items = cfg.items; do
            items["column"] = library:create("Frame", {
                ...
                BorderColor3 = rgb(0, 0, 0), Size = dim2(0, 0, cfg.size, 0),
                BorderSizePixel = 0, BackgroundColor3 = rgb(255, 255, 255),
            })
    ...
    function library:sub_tab(properties)
        ...
        local items = cfg.items; do
            items["tab_parent"] = library:create("Frame", {
                ...
                Name = "\0", Size = dim2(0, 0, cfg.size, 0),
                BorderColor3 = rgb(0, 0, 0), BorderSizePixel = 0,
                Visible = true, BackgroundColor3 = rgb(255, 255, 255),
            })
            library:create("UIListLayout", {
                FillDirection = Enum.FillDirection.Horizontal,
                HorizontalFlex = Enum.UIFlexAlignment.Fill,
                VerticalFlex = Enum.UIFlexAlignment.Fill,
                Parent = items["tab_parent"], Padding = dim(0, 7),
                SortOrder = Enum.SortOrder.LayoutOrder,
            })
        end
        return setmetatable(cfg, library)
    ...
    function library:section(properties)
        ...
        local items = cfg.items; do
            items["outline"] = library:create("Frame", {
                ...
                BorderSizePixel = 0, BackgroundColor3 = rgb(25, 25, 29),
            })
            ...
            items["scrolling"] = library:create("ScrollingFrame", {
                ...
                Size = dim2(1, 0, 1, -40), BackgroundTransparency = 1,
                Position = dim2(0, 0, 0, 35), BackgroundColor3 = rgb(255, 255, 255),
                BorderColor3 = rgb(0, 0, 0), BorderSizePixel = 0,
            ...
            items["button"] = library:create("TextButton", {
                ...
                Parent = items["outline"], Name = "\0",
                Position = dim2(0, 1, 0, 1), Size = dim2(1, -2, 0, 35),
                BorderSizePixel = 0, TextSize = 16, BackgroundColor3 = rgb(19, 19, 21),
            })
            library:create("UIStroke", {Color = rgb(23, 23, 29), Parent = items["button"], Enabled = false, ApplyStrokeMode = Enum.ApplyStrokeMode.Border})
            library:create("UICorner", {Parent = items["button"], CornerRadius = dim(0, 7)})

            items["Icon"] = library:create("ImageLabel", {
                ImageColor3 = themes.preset.accent, BorderColor3 = rgb(0, 0, 0),
                Parent = items["button"], AnchorPoint = vec2(0, 0.5),
                Image = cfg.icon, BackgroundTransparency = 1,
                Position = dim2(0, 10, 0.5, 0), Name = "\0",
                Size = dim2(0, 22, 0, 22), BorderSizePixel = 0,
            ...
            items["section_title"] = library:create("TextLabel", {
                ...
                BorderColor3 = rgb(0, 0, 0), Text = cfg.name,
                Parent = items["button"], Name = "\0",
                Size = dim2(0, 0, 1, 0), Position = dim2(0, 40, 0, -1),
                BackgroundTransparency = 1, TextXAlignment = Enum.TextXAlignment.Left,
                BorderSizePixel = 0, AutomaticSize = Enum.AutomaticSize.X,
                TextSize = 16, BackgroundColor3 = rgb(255, 255, 255),
            })
            ...
            if cfg.fading_toggle then
                ...
                items["toggle_outline"] = library:create("Frame", {
                    Parent = items["toggle"], Size = dim2(1, -2, 1, -2),
                    Name = "\0", BorderMode = Enum.BorderMode.Inset,
                    BorderColor3 = rgb(0, 0, 0), Position = dim2(0, 1, 0, 1),
                    BorderSizePixel = 0, BackgroundColor3 = rgb(50, 50, 50),
                })
                ...
                items["toggle_circle"] = library:create("Frame", {
                    Parent = items["toggle_outline"], Name = "\0",
                ...
                items["fade"] = library:create("Frame", {
                    Parent = items["outline"], BackgroundTransparency = 0.8,
                    Name = "\0", BorderColor3 = rgb(0, 0, 0),
                    Size = dim2(1, 0, 1, 0), BorderSizePixel = 0,
    ...
    function library:toggle(options)
        ...
        local items = cfg.items; do
            ...
            items["name"] = library:create("TextLabel", {
                FontFace = fonts.small, TextColor3 = rgb(245, 245, 245),
                BorderColor3 = rgb(0, 0, 0), Text = cfg.name,
                Parent = items["toggle"], Name = "\0", Size = dim2(1, 0, 0, 0),
                BackgroundTransparency = 1, TextXAlignment = Enum.TextXAlignment.Left,
                BorderSizePixel = 0, AutomaticSize = Enum.AutomaticSize.XY,
                TextSize = 16, BackgroundColor3 = rgb(255, 255, 255),
            })
            ...
            if cfg.info then
                library:create("TextLabel", {
                    ...
                    Parent = items["toggle"], Name = "\0",
                    Position = dim2(0, 5, 0, 17), Size = dim2(1, -10, 0, 0),
                    BackgroundTransparency = 1, TextXAlignment = Enum.TextXAlignment.Left,
                    BorderSizePixel = 0, AutomaticSize = Enum.AutomaticSize.XY,
                    TextSize = 16, BackgroundColor3 = rgb(255, 255, 255),
                })
            ...
            library:create("UIListLayout", {
                ...
                Parent = items["right_components"], Padding = dim(0, 9),
                SortOrder = Enum.SortOrder.LayoutOrder,
            })
            ...
            if cfg.type == "checkbox" then
                items["toggle_button"] = library:create("TextButton", {
                    FontFace = fonts.small, TextColor3 = rgb(0, 0, 0),
                    BorderColor3 = rgb(0, 0, 0), Text = "", LayoutOrder = 2,
                    AutoButtonColor = false, AnchorPoint = vec2(1, 0),
                    Parent = items["right_components"], Name = "\0",
                    Position = dim2(1, 0, 0, 0), Size = dim2(0, 16, 0, 16),
                    BorderSizePixel = 0, TextSize = 14, BackgroundColor3 = rgb(67, 67, 68),
                })
                ...
                items["outline"] = library:create("Frame", {
                    Parent = items["toggle_button"], Size = dim2(1, -2, 1, -2),
                    Name = "\0", BorderMode = Enum.BorderMode.Inset,
                    BorderColor3 = rgb(0, 0, 0), Position = dim2(0, 1, 0, 1),
                    BorderSizePixel = 0, BackgroundColor3 = rgb(22, 22, 24),
                })
                ...
                items["tick"] = library:create("ImageLabel", {
                    ...
                    BackgroundTransparency = 1, Position = dim2(0, -1, 0, 0),
                    Parent = items["outline"], Size = dim2(1, 2, 1, 2),
                    BorderSizePixel = 0, BackgroundColor3 = rgb(255, 255, 255), ZIndex = 1,
                })
                library:create("UICorner", {Parent = items["outline"], CornerRadius = dim(0, 4)})
                library:create("UIGradient", {
                    Enabled = false, Parent = items["outline"],
                    Color = rgbseq{rgbkey(0, rgb(211, 211, 211)), rgbkey(1, rgb(211, 211, 211))},
                })
            else
                items["toggle_button"] = library:create("TextButton", {
                    ...
                    BorderColor3 = rgb(0, 0, 0), Text = "", LayoutOrder = 2,
                    AnchorPoint = vec2(1, 0.5), Parent = items["right_components"],
                    Name = "\0", Position = dim2(1, -9, 0.5, 0),
                    Size = dim2(0, 36, 0, 18), BorderSizePixel = 0,
                    TextSize = 14, BackgroundColor3 = themes.preset.accent,
                })
                library:apply_theme(items["toggle_button"], "accent", "BackgroundColor3")
                ...
                items["circle"] = library:create("Frame", {
                    Parent = items["inline"], Name = "\0",
                    Position = dim2(1, -14, 0, 2), BorderColor3 = rgb(0, 0, 0),
                    Size = dim2(0, 12, 0, 12), BorderSizePixel = 0,
                    BackgroundColor3 = rgb(255, 255, 255),
                })
        ...
        if cfg.seperator then
            library:create("Frame", {
                ...
                Position = dim2(0, 0, 1, 0), BorderColor3 = rgb(0, 0, 0),
                Size = dim2(1, 1, 0, 1), BorderSizePixel = 0,
                BackgroundColor3 = rgb(36, 36, 37),
            })
        end
        ...
        local items = cfg.items; do
            ...
            if cfg.info then
                library:create("TextLabel", {
                    ...
                    BorderColor3 = rgb(0, 0, 0), TextWrapped = true, Text = cfg.info,
                    Parent = items["slider_object"], Name = "\0",
                    Position = dim2(0, 5, 0, 37), Size = dim2(1, -10, 0, 0),
                    BackgroundTransparency = 1, TextXAlignment = Enum.TextXAlignment.Left,
                    BorderSizePixel = 0, AutomaticSize = Enum.AutomaticSize.XY,
                    TextSize = 16, BackgroundColor3 = rgb(255, 255, 255),
                })
            ...
            items["right_components"] = library:create("Frame", {
                Parent = items["slider_object"], Name = "\0",
                BackgroundTransparency = 1, Position = dim2(0, 4, 0, 23),
                BorderColor3 = rgb(0, 0, 0), Size = dim2(1, 0, 0, 12),
                BorderSizePixel = 0, BackgroundColor3 = rgb(255, 255, 255),
            })
            library:create("UIListLayout", {
                Parent = items["right_components"], Padding = dim(0, 7),
                SortOrder = Enum.SortOrder.LayoutOrder, FillDirection = Enum.FillDirection.Horizontal,
            })
            items["slider"] = library:create("TextButton", {
                FontFace = fonts.small, TextColor3 = rgb(0, 0, 0),
                BorderColor3 = rgb(0, 0, 0), Text = "", AutoButtonColor = false,
                AnchorPoint = vec2(1, 0), Parent = items["right_components"],
                Name = "\0", Position = dim2(1, 0, 0, 0),
                Size = dim2(1, -4, 0, 4), BorderSizePixel = 0,
                TextSize = 14, BackgroundColor3 = rgb(33, 33, 35),
            })
            library:create("UICorner", {Parent = items["slider"], CornerRadius = dim(0, 999)})
            items["fill"] = library:create("Frame", {
                Name = "\0", Parent = items["slider"],
                BorderColor3 = rgb(0, 0, 0), Size = dim2(0.5, 0, 0, 4),
                BorderSizePixel = 0, BackgroundColor3 = themes.preset.accent,
            })
            ...
            items["value"] = library:create("TextLabel", {
                FontFace = fonts.small, TextColor3 = rgb(72, 72, 73),
    ...
    function library:dropdown(options)
        ...
        local items = cfg.items; do
            ...
            items["indicator"] = library:create("ImageLabel", {
                ImageColor3 = rgb(86, 86, 87), BorderColor3 = rgb(0, 0, 0),
                Parent = items["dropdown"], AnchorPoint = vec2(1, 0.5),
                Image = "rbxassetid://101025591575185",
                BackgroundTransparency = 1, Position = dim2(1, -5, 0.5, 0),
                Name = "\0", Size = dim2(0, 12, 0, 12),
                BorderSizePixel = 0, BackgroundColor3 = rgb(255, 255, 255),
            })
            ...
            library:create("UIPadding", {
                ...
                PaddingLeft = dim(0, 3), Parent = items["outline"],
            })
    ...
    function library:label(options)
        ...
        local items = cfg.items; do
            ...
            items["name"] = library:create("TextLabel", {
                ...
                TextXAlignment = Enum.TextXAlignment.Left, BorderSizePixel = 0,
                AutomaticSize = Enum.AutomaticSize.XY, TextSize = 16,
                RichText = true, BackgroundColor3 = rgb(255, 255, 255),
            })
            if cfg.info then
                library:create("TextLabel", {
                    FontFace = fonts.small, TextColor3 = rgb(130, 130, 130),
    ...
    function library:colorpicker(options)
        ...
        local items = cfg.items; do
            items["colorpicker"] = library:create("TextButton", {
                ...
                TextSize = 14, BackgroundColor3 = rgb(54, 31, 184),
            })
            ...
            items["colorpicker_inline"] = library:create("Frame", {
                ...
                Name = "\0", BorderMode = Enum.BorderMode.Inset,
                BorderColor3 = rgb(0, 0, 0), Position = dim2(0, 1, 0, 1),
                BorderSizePixel = 0, BackgroundColor3 = rgb(54, 31, 184),
            })
            ...
            items["colorpicker_holder"] = library:create("Frame", {
                ...
                Position = dim2(0.2, 20, 0.297, 0), BorderColor3 = rgb(0, 0, 0),
                Size = dim2(0, 166, 0, 197), BorderSizePixel = 0,
                Visible = true, BackgroundColor3 = rgb(25, 25, 29),
            })
            items["colorpicker_fade"] = library:create("Frame", {
                Parent = items["colorpicker_holder"], Name = "\0",
                BackgroundTransparency = 0, Position = dim2(0, 0, 0, 0),
            ...
            items["saturation_holder"] = library:create("Frame", {
                ...
                Size = dim2(1, -14, 1, -80), BorderSizePixel = 0,
            ...
            items["val"] = library:create("Frame", {
                Name = "\0", Parent = items["saturation_holder"],
                BorderColor3 = rgb(0, 0, 0), Size = dim2(1, 0, 1, 0),
                BorderSizePixel = 0, BackgroundColor3 = rgb(255, 255, 255),
            })
            ...
            items["satvalpicker"] = library:create("TextButton", {
                ...
                Name = "\0", Position = dim2(0, 0, 4, 0),
                Size = dim2(0, 8, 0, 8), ZIndex = 5, BorderSizePixel = 0,
            ...
            items["hue_gradient"] = library:create("TextButton", {
                Parent = items["colorpicker_components"], Name = "\0",
                Position = dim2(0, 10, 1, -64), BorderColor3 = rgb(0, 0, 0),
                Size = dim2(1, -20, 0, 8), BorderSizePixel = 0,
            ...
            items["alpha_gradient"] = library:create("TextButton", {
                Parent = items["colorpicker_components"], Name = "\0",
                Position = dim2(0, 10, 1, -46), BorderColor3 = rgb(0, 0, 0),
                Size = dim2(1, -20, 0, 8), BorderSizePixel = 0,
            ...
            items["alpha_indicator"] = library:create("ImageLabel", {
                ...
                BackgroundTransparency = 1, Name = "\0",
                Size = dim2(1, 0, 1, 0), TileSize = dim2(0, 6, 0, 6),
            ...
            library:create("UIGradient", {
                Rotation = 90, Parent = items["colorpicker_components"],
            ...
            items["input"] = library:create("TextBox", {
                ...
                BackgroundColor3 = rgb(33, 33, 35), TextColor3 = rgb(72, 72, 72),
                BorderColor3 = rgb(0, 0, 0),
                Position = dim2(1, -8, 1, -11), Size = dim2(1, -16, 0, 18),
            })
        ...
        function cfg.set(color, alpha)
            ...
            items["input"].Text = string.format("%s, %s, %s, %s",
                library:round(c.R * 255), library:round(c.G * 255),
                library:round(c.B * 255), library:round(1 - a, 0.01))
        ...
        items["input"].FocusLost:Connect(function()
            local r, g, b, al = library:convert(items["input"].Text)
    ...
    function library:textbox(options)
        ...
        local items = cfg.items; do
            items["textbox"] = library:create("TextButton", {
                LayoutOrder = -1, FontFace = fonts.font, TextColor3 = rgb(0, 0, 0),
                BorderColor3 = rgb(0, 0, 0), Text = "",
                Parent = self.items["elements"], Name = "\0",
                BackgroundTransparency = 1, Size = dim2(1, 0, 0, 0),
                BorderSizePixel = 0, AutomaticSize = Enum.AutomaticSize.Y,
            ...
            items["right_components"] = library:create("Frame", {
                Parent = items["textbox"], Name = "\0",
                BackgroundTransparency = 1, Position = dim2(0, 4, 0, 19),
                BorderColor3 = rgb(0, 0, 0), Size = dim2(1, 0, 0, 12),
                BorderSizePixel = 0, BackgroundColor3 = rgb(255, 255, 255),
            })
            library:create("UIListLayout", {
            ...
            items["input"] = library:create("TextBox", {
                ...
                Parent = items["right_components"], Name = "\0",
                TextTruncate = Enum.TextTruncate.AtEnd, BorderSizePixel = 0,
                PlaceholderColor3 = rgb(255, 255, 255), PlaceholderText = cfg.placeholder,
                CursorPosition = -1, ClearTextOnFocus = false,
                TextSize = 14, BackgroundColor3 = rgb(33, 33, 35),
                TextColor3 = rgb(72, 72, 72), BorderColor3 = rgb(0, 0, 0),
                Position = dim2(1, 0, 0, 0), Size = dim2(1, -4, 0, 30),
            })
            library:create("UICorner", {Parent = items["input"], CornerRadius = dim(0, 3)})
    ...
    function library:keybind(options)
        ...
        local items = cfg.items; do
            ...
            items["keybind_holder"] = library:create("TextButton", {
                FontFace = fonts.font, TextColor3 = rgb(0, 0, 0),
                BorderColor3 = rgb(0, 0, 0), Text = "",
                Parent = items["right_components"], AutoButtonColor = false,
                AnchorPoint = vec2(1, 0), Size = dim2(0, 0, 0, 16),
                Name = "\0", Position = dim2(1, 0, 0, 0),
                BorderSizePixel = 0, AutomaticSize = Enum.AutomaticSize.X,
                TextSize = 14, BackgroundColor3 = rgb(33, 33, 35),
            })
            ...
            items["key"] = library:create("TextLabel", {
                FontFace = fonts.font, TextColor3 = rgb(86, 86, 87),
                BorderColor3 = rgb(0, 0, 0), Text = "LSHIFT",
            ...
            items["dropdown"] = library:create("Frame", {
                ...
                Position = dim2(0, 0, 0, 0), Size = dim2(0, 0, 0, 0),
                BorderSizePixel = 0, AutomaticSize = Enum.AutomaticSize.X,
                BackgroundColor3 = rgb(0, 0, 0),
            })
            items["inline"] = library:create("Frame", {
                Parent = items["dropdown"], Size = dim2(1, 0, 1, 0),
                Name = "\0", ClipsDescendants = true,
                BorderColor3 = rgb(0, 0, 0), BorderSizePixel = 0,
                BackgroundColor3 = rgb(22, 22, 24),
            })
            library:create("UIPadding", {
            ...
            local options_mode = {"Hold", "Toggle", "Always"}
            cfg.y_size = 20
            for _, option in options_mode do
    ...
    function library:button(options)
        ...
        local items = cfg.items; do
            ...
            items["button"] = library:create("TextButton", {
                FontFace = fonts.font, TextColor3 = rgb(0, 0, 0),
                BorderColor3 = rgb(0, 0, 0), Text = "", AutoButtonColor = false,
                AnchorPoint = vec2(1, 0), Parent = items["button_element"],
                Name = "\0", Position = dim2(1, -4, 0, 0),
                Size = dim2(1, -8, 0, 30), BorderSizePixel = 0,
                TextSize = 14, BackgroundColor3 = rgb(33, 33, 35),
            })
    ...
    function library:settings(options)
        ...
        local items = cfg.items; do
            items["outline"] = library:create("Frame", {
                Name = "\0", Visible = true, Parent = library["items"],
                BorderColor3 = rgb(0, 0, 0), Size = dim2(0, 0, 0, 0),
                ClipsDescendants = true, BorderSizePixel = 0,
                AutomaticSize = Enum.AutomaticSize.Y, BackgroundColor3 = rgb(25, 25, 29),
            })
            items["inline"] = library:create("Frame", {
                Parent = items["outline"], Name = "\0",
                Position = dim2(0, 1, 0, 1), BorderColor3 = rgb(0, 0, 0),
            ...
            library:create("UICorner", {Parent = items["inline"], CornerRadius = dim(0, 7)})
            items["elements"] = library:create("Frame", {
                BorderColor3 = rgb(0, 0, 0), Parent = items["inline"],
                Name = "\0", BackgroundTransparency = 1,
                Position = dim2(0, 10, 0, 10), Size = dim2(1, -20, 0, 0),
                BorderSizePixel = 0, AutomaticSize = Enum.AutomaticSize.Y,
                BackgroundColor3 = rgb(255, 255, 255),
            })
            library:create("UIListLayout", {Parent = items["elements"], Padding = dim(0, 10), SortOrder = Enum.SortOrder.LayoutOrder})
            ...
            items["tick"] = library:create("ImageButton", {
                Image = "rbxassetid://128797200442698", Name = "\0",
                AutoButtonColor = false, Parent = self.items["right_components"],
                BorderColor3 = rgb(0, 0, 0), Size = dim2(0, 16, 0, 16),
                BorderSizePixel = 0, BackgroundColor3 = rgb(255, 255, 255),
            })
        end
        ...
        function cfg.refresh_options(options_to_refresh)
            ...
            for _, option_data in options_to_refresh do
                local button = library:create("TextButton", {
                    FontFace = fonts.small, TextColor3 = rgb(0, 0, 0),
                    BorderColor3 = rgb(0, 0, 0), Text = "", AutoButtonColor = false,
                    AnchorPoint = vec2(1, 0), Parent = items["list"], Name = "\0",
                    Position = dim2(1, 0, 0, 0), Size = dim2(1, 0, 0, 30),
    ...
    function library:init_config(window)
        ...
        local section = column:section({name = "Configs", size = 1, icon = GetImage("Settings.png")})
        ...
        column = main:column({})
        section = column:section({name = "Options", side = "right", size = 1, icon = GetImage("Settings.png")})
        ...
        section:button({
            ...
            callback = function()
                pcall(function()
                    ...
                    library:update_config_list()
                    notifications:create_notification({name = "Config", info = "Saved: " .. config_name})
                end)
            end,
        })
        section:button({
            ...
            callback = function()
                pcall(function()
                    ...
                    library:update_config_list()
                    notifications:create_notification({name = "Config", info = "Loaded: " .. config_name})
                end)
            end,
        })
        section:button({
            ...
            callback = function()
                pcall(function()
                    ...
                    library:update_config_list()
                    notifications:create_notification({name = "Config", info = "Deleted: " .. config_name})
                end)
            end,
        })
        section:colorpicker({
    ...
    function notifications:create_notification(options)
        ...
        local items = cfg.items; do
            items["notification"] = library:create("Frame", {
                Parent = library["items"], Size = dim2(0, 210, 0, 53),
                Name = "\0", BorderColor3 = rgb(0, 0, 0),
                BorderSizePixel = 0, BackgroundTransparency = 1,
                AnchorPoint = vec2(1, 0), AutomaticSize = Enum.AutomaticSize.Y,
                BackgroundColor3 = rgb(14, 14, 16),
            })
            library:create("UIStroke", {
                Color = rgb(23, 23, 29), Parent = items["notification"],
            ...
            items["title"] = library:create("TextLabel", {
                ...
                BackgroundTransparency = 1, Position = dim2(0, 7, 0, 6),
                BorderSizePixel = 0, AutomaticSize = Enum.AutomaticSize.XY,
                TextSize = 14, BackgroundColor3 = rgb(255, 255, 255),
            })
            ...
            items["info"] = library:create("TextLabel", {
                ...
                Parent = items["notification"], Name = "\0",
                Position = dim2(0, 9, 0, 22), BorderSizePixel = 0,
                BackgroundTransparency = 1, TextXAlignment = Enum.TextXAlignment.Left,
            ...
            items["bar"] = library:create("Frame", {
                ...
                Name = "\0", Position = dim2(0, 8, 1, -6),
                BorderColor3 = rgb(0, 0, 0), Size = dim2(0, 0, 0, 5),
